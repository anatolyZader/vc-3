...
jest.mock(
  path.join(__dirname, "../../../../../business_modules/ai/infrastructure/ai/rag_pipelines/data_preparation/orchestrators/commitManager"),
...
jest.mock(
  path.join(__dirname, "../../../../../business_modules/ai/infrastructure/ai/rag_pipelines/data_preparation/orchestrators/processingStrategyManager"),
  () => jest.fn().mockImplementation(() => ({
...
jest.mock(
  path.join(__dirname, "../../../../../business_modules/ai/infrastructure/ai/rag_pipelines/data_preparation/orchestrators/documentProcessingOrchestrator"),
  () => jest.fn().mockImplementation(() => ({
...
jest.mock(
  path.join(__dirname, "../../../../../business_modules/ai/infrastructure/ai/rag_pipelines/data_preparation/orchestrators/eventManager"),
  () => jest.fn().mockImplementation(() => ({
